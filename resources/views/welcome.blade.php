...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen sm:items-centre bg-white py-4 sm:pt-0">
                <div class="navbar-nav ml-auto py-0">
                    <h1><b>XE</b>ÑAL</h1>
                    <form class="d-flex justify-content-between mr-2 p-2 mt-3">
                        <a href="{{ route('login') }}" class="form-control btn btn-success"
                        role="button">Login</a>
                    </form>
                    <form class="d-flex justify-content-between mr-2 p-2 mt-3">
