                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('encargados.destroy',$encargado->id) }}" method="POST">
                                                    ...
                                                    @can('encargados.edit') <a class="btn btn-sm btn-success" href="{{ route('encargados.edit',$encargado->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a> @endcan
                                                    @csrf
                                                    @can('encargados.destroy') 
                                                    @method('DELETE')
